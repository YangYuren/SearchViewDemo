...
- (void)configResultDoubleViewCellWithFirstTitle:(NSString *)firstTitle secondTitle:(NSString *)secondTitle
{
    ...
    if (KScreenWidth > 375) {
        _leftImage.image = [UIImage imageNamed:@"leftImage576.jpeg"];
        _rightImage.image = [UIImage imageNamed:@"rightImage576.jpeg"];
    } else {
        _leftImage.image = [UIImage imageNamed:@"leftImage345.jpeg"];
        _rightImage.image = [UIImage imageNamed:@"rightImage345.jpeg"];
    }
